...
class BrandSettingSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('brand_settings')->insert([ 'key_name' => 'company_alias', 'key_value' => 'BRT', 'created_by' => 1 ]);
        DB::table('brand_settings')->insert([ 'key_name' => 'company_name', 'key_value' => 'Book Rider Test', 'created_by' => 1 ]);
